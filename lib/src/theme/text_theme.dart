...
class AppTextTheme extends ThemeExtension<AppTextTheme> {
  ...
  /*Title*/
  //Title Large
  static const num _titleLargeFontSize = 20.0;
  static num get _titleLargeLineHeight => (24.0 / _titleLargeFontSize); //1.4

  //Title Medium
  static const num _titleMediumFontSize = 18.0;
  static num get _titleMediumLineHeight => (18.0 / _titleMediumFontSize); //1.5
